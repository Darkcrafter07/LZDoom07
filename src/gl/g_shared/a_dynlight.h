...
enum LightFlag
{
	...
	LF_SPOT = 64,
	LF_CAMGLOWSTRAIGHT = 128, // GL1x/GL2x software sector light mode straight (non-radial) dynlight imitation
};
...
public:
	...
	// GL1x/GL2x software sector light mode straight (non-radial) dynlight imitation
