...
public:
	...
	public:
		...
		{
			const int firstword = reg / 32;       // Find which VM_UWORD in the array
			const int firstbit = reg & 31;        // Find which bit within the VM_UWORD
			return (Dirty[firstword] & (1 << firstbit)) != 0;
		}
